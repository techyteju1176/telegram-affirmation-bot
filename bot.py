...
# ---- REMINDER TRACKING ----
last_seen = time.time()  # tracks last time Radhika sent a message
reminder_sent = False    # prevents sending reminder repeatedly
...
def check_reminder():
    ...
    hours_48 = 48 * 60 * 60  # 48 hours in seconds
...
def handle_message(text, user_id):
    ...
    # ---- HOW IS RADHIKA ----
        ...
        return "😊 Queen Radhika        if is_radhika:
            return "🛡️ You are, Radhika. Your strength doesn't shout — it stands firm, calm, and completely unbothered."
        return "🛡️ Queen Radhika — strength that doesn't shout, it simply stands firm and unbothered."
